...
<div class="row mt-4 mb-3">
               <div class="col-6"> <h4 class="mt-0">  {{$category_name->week}}  Product Edit Form</h4></div>
                     <div class="col-3">
 ...
 <div class="container shadow p-4">
      <form method="POST" action="{{url('admin/product_update/'.$data->id)}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          ...
          <div class="col-sm-3 my-2">
            ...
            <input type="text" name="product_id" id="product_id" class="form-control" value="{{ $data->product_id }}" >
          </div>

          <div class="col-sm-3 my-2">
              <label for="image">Image 1 (Max Size:600KB)  </label>
    ...
    <div class="mb-3">
          ...
          <textarea name="desc1" id="summernote1" cols="30" rows="5"> {!! $data->desc1  !!}</textarea>
    </div> 

    
    <div class="mb-3">
          <label for="exampleFormControlTextarea1" class="form-label"> Description 2</label>
          <textarea name="desc2" id="summernote2" cols="30" rows="5" > {!! $data->desc2  !!} </textarea>
    </div> 
