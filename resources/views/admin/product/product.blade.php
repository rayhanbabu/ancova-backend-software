...
@section('content')
  ...
  <div class="card mt-3 mb-0"> 
    ...
    <div class="row ">
               <div class="col-6"> <h4 class="mt-0">{{$category_name->week}} Product List</h4></div>
                     <div class="col-3">
                     ...
                     <div class="col-3">
                         ...
                         <a class="btn btn-primary" href="{{url('/admin/product_create/'.$category)}}" role="button">Add</a>
              </div>
        </div> 
 </div> 
...
<div class="x_content">
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    ...
    <tr>
         ...
         <th width="10%" class="sorting" data-sorting_type="asc" data-column_name="product_id" style="cursor: pointer"> Product id 
           <span id="product_id_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
  ...
  $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
     ...
     $('#add').click(function(){  
         ...
         function fetch(){
            $.ajax({
             type:'GET',
             url:'/admin/product_fetch/{{$category}}',
             datType:'json',
    ...
    function fetch_data(page, sort_type="", sort_by="", search=""){
        $.ajax({
        url:"/admin/product/fetch_data/{{$category}}?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search,
