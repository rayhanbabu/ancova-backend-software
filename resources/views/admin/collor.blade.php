...
@section('collor','active')
@section('content')

<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Contact View </h5></div>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               ...
               <input type="text" name="collor_name" id="collor_name" class="form-control" placeholder="" required>
               <p class="text-danger error_collor_name"></p>
            </div>
            ...
            <div class="col-lg-12 my-2">
                <label for="roll">Subject  </span></label>
            ...
            <div class="col-lg-12 my-2">
                ...
                <input type="text" name="collor_des" id="collor_des" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
               <label for="roll">Name<span style="color:red;"> * </span></label>
               <input type="text" name="collor_name" id="edit_collor_name" class="form-control" placeholder="" required>
               <p class="text-danger error_collor_name"></p>
            </div>
            ...
            <div class="col-lg-12 my-2">
                <label for="roll">Subject  </span></label>
                <input type="text" name="subject" id="edit_subject" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
            ...
            <div class="col-lg-12 my-2">
                <label for="roll">Description  </span></label>
                <input type="text" name="collor_des" id="edit_collor_des" class="form-control" placeholder="" >
                <p class="text-danger error_designation"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Collor Status</b></label>
                    <select class="form-select" name="collor_status" id="edit_collor_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/collor_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_collor_name").val(response.data.collor_name);
              $("#edit_collor_des").val(response.data.collor_des);
              $("#edit_email").val(response.data.email);
              $("#edit_phone").val(response.data.phone);
              $("#edit_subject").val(response.data.subject);
              $("#edit_collor_status").val(response.data.collor_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/collor/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
