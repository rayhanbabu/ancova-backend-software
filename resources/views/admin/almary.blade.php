...
@section('almary','active')
@section('content')

<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Almary  </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="almary_name" style="cursor: pointer"> Name 
                <span id="almary_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               ...
               <input type="text" name="almary_name" id="almary_name" class="form-control" placeholder="" required>
               <p class="text-danger error_almary_name"></p>
            </div>
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <input type="hidden" name="edit_id" id="edit_id">
             ...
             <div class="col-lg-12 my-2">
                <label for="roll">Name<span style="color:red;"> * </span></label>
                <input type="text" name="almary_name" id="edit_almary_name" class="form-control" placeholder="" required>
                <p class="text-danger error_almary_name"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>almary Status</b></label>
                    <select class="form-select" name="almary_status" id="edit_almary_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/almary_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_almary_name").val(response.data.almary_name);
              $("#edit_almary_status").val(response.data.almary_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/almary/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
