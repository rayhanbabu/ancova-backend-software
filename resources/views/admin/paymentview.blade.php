...
<div class="card mt-4 mb-3">
    ...
    <div class="row">
               <div class="col-2"> <h5 class="mt-0">Payment View</h5></div>
                     ...
                     <div class="col-2">
                         ...
                         <a class="btn btn-primary btn-sm" href="{{url('/admin/payment_refresh')}}" role="button">Refresh </a>
                        </div>
                     </div> 
             </div>
  ...
  <div class="bazar-entry-show" style="background-color:aliceblue; padding:10px;">
   ...
   <form method="post" id="add_form" enctype="multipart/form-data">
    <div class="row">
      <div class="col-sm-3">
        <label>Client Name or Phone <span style="color:red;"> * </span></label><br>
         <select name="client_id" id="client_id" class="js-example-disabled-results" style="width:300px;" required>
                     <option value=""> Select Client Name or Phone Number </option>
                @foreach($client as $row)
                     <option value="{{ $row->id}}">{{ $row->client_name}} - {{ $row->phone}}</option>
                @endforeach
          </select>
      </div>
      ...
      <div class="col-sm-3">
        <label>Service Description <span style="color:red;"> * </span></label><br>
        <input type="text" name="service_info" id="service_info" class="form-control form-control-sm" placeholder="" required>    
      </div>


      <div class="col-sm-2">
          <label>Total Payment <span style="color:red;"> * </span></label><br>
          <input type="number" name="total_payment" id="total_payment" class="form-control form-control-sm" placeholder="" required>
      </div>
...
<div class="card-block table-border-style">                     
 <div class="table-responsive">
   ...
   <thead>
       <tr>
       <th width="10%" class="sorting" data-sorting_type="asc" data-column_name="id" style="cursor: pointer" >Payment ID
                <span id="id_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
       <th  width="20%">Name</th>
       <th width="10%" class="sorting" data-sorting_type="asc" data-column_name="service_info" style="cursor: pointer">Service info
                  <span id="service_info_icon"><i class="fas fa-sort-amount-up-alt"></span></th>
      <th  width="10%">Invoice date</th>            
      <th  width="10%">Payment</th>
		  <th width="10%" class="sorting" data-sorting_type="asc" data-column_name="payment_status" style="cursor: pointer">Payment Status
                  <span id="payment_status_icon"><i class="fas fa-sort-amount-up-alt"></span></th>
